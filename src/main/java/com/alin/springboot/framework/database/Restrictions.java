package com.alin.springboot.framework.database;

import com.alin.springboot.framework.database.Criterion.Operator;
...
public class Restrictions {
    ...
    public static SimpleExpression like(String fieldName, String value, boolean ignoreNull) {
        ...
        return new SimpleExpression(fieldName, value.trim(), Operator.LIKE);
    }
    ...
    public static LogicalExpression in(String fieldName, Collection value, boolean ignoreNull) {
        ...
        return new LogicalExpression(ses, Operator.IN);
    }
